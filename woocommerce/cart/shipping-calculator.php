...
<form class="shipping_calculator" action="<?php echo esc_url( $woocommerce->cart->get_cart_url() ); ?>" method="post">
	...
	<h2><a href="#" class="shipping-calculator-button"><?php _e( 'Calculate Shipping', 'woocommerce' ); ?> <span class="icon-angle-down"></span></a></h2>

	<section class="shipping-calculator-form">

		<p class="form-row form-row-wide">
        <div class="select-picker">
			<select name="calc_shipping_country" id="calc_shipping_country" class="country_to_state selectpicker" rel="calc_shipping_state">
		...
		<p class="form-row form-row-wide">
			<?php
				...
				// Dropdown Input
					...
					?><span>
                      <div class="select-picker">
						<select name="calc_shipping_state" class="selectpicker" id="calc_shipping_state" placeholder="<?php _e( 'State / county', 'woocommerce' ); ?>">
		...
		<p><button type="submit" name="calc_shipping" value="1" class="checkout-button btn"><?php _e( 'Update Totals', 'woocommerce' ); ?></button></p>
