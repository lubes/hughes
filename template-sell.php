 ...
 * Description: A template for the sell page
 *
 */
...
<div class="container">
 ...
 ?>
  ...
  <section class="seller-info mobl">
    <div class="container"> 
      <!-- Example row of columns -->
      <div class="row-fluid equalHt" id="blocks">
        <article class="span6 col mobl">
          <div class="content-entry">
            ...
            <span><a href="<?= site_url(); ?>/consignment-store-sales-form" class="btn drk-green">Start Now</a></span> </div>
        </article>
...
// Start the loop for  Products
						?>
<?php 
	echo do_shortcode( '[ajax_load_more container_type="div" post_type="sell_archive" posts_per_page="4" offset="8"  transition="fade" transition_container="false"]' );?>
</ul>
