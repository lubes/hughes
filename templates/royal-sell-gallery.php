  ...
  remove_all_filters('posts_orderby');
	...
	if ($attachments) {
		foreach ( $attachments as $attachment ) {
				...
				$small = wp_get_attachment_image_src( $attachment->ID, 'large');
				?>
   <div><img class="rsImg" src="<?php echo $small[0]; ?>" alt="<?php echo $alt; ?>" />
     <div class="fig-wrap"> 
     <?php if($attachment->_staffPx) {  echo '<figure class="staffPic active"></figure>'; } ?>
     </div>
    <div class="bx-wrap">
