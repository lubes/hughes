...
var Grid = (function() {
	...
	function initItemsEvents( $items ) {
		$items.on( 'click', 'span.og-close', function() {
			hidePreview();
			return false;
		} ).children( '.data-wrapper' ).on( 'click', function(e) {
	...
	Preview.prototype = {
		...
		update : function( $item ) {
			...
			var $itemEl = this.$item.children( '.data-wrapper' ),
				eldata = {
		...
		calcHeight : function() {
			...
			innerHeight = this.$item.children('.og-expander').children('.og-expander-inner').height();
			this.height = heightPreview;
			this.itemHeight = heightPreview + innerHeight + 46;
