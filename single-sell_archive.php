...
<body <?php body_class('gallery single-product '); ?>>
<!--[if lt IE 7]><div class="alert">You are using an <strong>outdated</strong> browser. Please <a href="http://browsehappy.com/">upgrade your browser</a> or <a href="http://www.google.com/chromeframe/?redirect=true">activate Google Chrome Frame</a> to improve your experience.</div><![endif]-->

<?php get_template_part('templates/header');  ?>
<div class="light_square"><?php if($_GET['email'] == 'true'){ ?> <a class="close-button" href="<?= site_url(); ?>/showroom-sales"><i class="close-ico"></i></a> <?php } else { ?> <a class="close-button" href="javascript: history.go(-1)"><i class="close-ico"></i></a> <?php } ?>
...
<?php if($_GET['email'] == 'true'){ 
	echo '<a href="/showroom-sales/"><i class="back-icon"></i> back to sales</a>'; 
} else { 
